            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-100">
                <form method="POST" action="{{ route('categories.store') }}" class="px-6 py-6 space-y-6">
                    ...
                    <div class="flex justify-end space-x-3">
                        <a href="{{ route('categories.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                            {{ __('Cancel') }}
                        </a>
